...
/*
    ...
    It changes to whatever I typed in for the query
*/
...
function clearCharacters() {
    let reset = document.getElementById("foodList").innerHTML;
    reset = ``  }
// CODE HERE 

const createFood = () => {
    event.preventDefault();
    let foodInput = document.querySelector("#inputText")
    let body = {
    ...
    .then((response) => {
        ...
        for (let i = 0; i < items.length; i++){
            ...
            console.log(text)
            li.appendChild(text);
            document.querySelector("#displayList").appendChild(li)
        }
})
}
